...
To vibe coding for free I use [Codex](https://ChatGPT.com/codex). You can connect it directly to GitHub. You will probably have to fork the project first so that you can edit it. It has a free quota that can be extended when you switch the account. It is available in the browser for Android. Always enter several tasks at once, numbered and written very precisely and in detail.
