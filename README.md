...
Some models no longer work because Google is changing the interfaces (API). You can usually find the current API names at [aistudio.google.com](aistudio.google.com), but you might not find them all there.
